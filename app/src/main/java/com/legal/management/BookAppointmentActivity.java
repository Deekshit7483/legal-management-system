...
public class BookAppointmentActivity extends AppCompatActivity {
				...
				if (edittext1.getText().toString().equals("")) {
					...
					if (edittext2.getText().toString().equals("")) {
						...
						if (edittext3.getText().toString().equals("")) {
							...
							if (typ.equals("select type")) {
								SketchwareUtil.showMessage(getApplicationContext(), "Select type");
							}
							else {
								ke = appointment.push().getKey();
								map = new HashMap<>();
								map.put("uid", FirebaseAuth.getInstance().getCurrentUser().getUid());
								map.put("name", edittext1.getText().toString());
								map.put("contact", edittext2.getText().toString());
								map.put("case description", edittext3.getText().toString());
								map.put("type", typ);
								map.put("key", ke);
								map.put("status", "pending");
								map.put("lawyer uid", getIntent().getStringExtra("uid"));
								map.put("lawyer name", getIntent().getStringExtra("lawyer name"));
								map.put("lawyer contact", getIntent().getStringExtra("lawyer contact"));
								map.put("lawyer amount", getIntent().getStringExtra("amount"));
								map.put("lawyer address", getIntent().getStringExtra("lawyer address"));
								appointment.child(ke).updateChildren(map);
								map.clear();
								d.setTitle("Legal Management");
								d.setIcon(R.drawable.logo);
								d.setMessage("Successfully booked your appointment");
								d.setPositiveButton("Go to Dashboard", new DialogInterface.OnClickListener() {
									@Override
	...
	private void initializeLogic() {
		data.add("Select type");
		data.add("Virtual");
		data.add("Person");
		spinner1.setAdapter(new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_spinner_dropdown_item, data));
	}
