...
public class LPendingAppActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.l_pending_app);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			if (_data.get((int)_position).get("lawyer uid").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
