...
public class EditProfileLawyerActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.edit_profile_lawyer);
	...
	private void initialize(Bundle _savedInstanceState) {
				...
				if (name.getText().toString().equals("")) {
					...
					if (contact.getText().toString().equals("")) {
						...
						if (amount.getText().toString().equals("")) {
							SketchwareUtil.showMessage(getApplicationContext(), "enter amount");
						}
						else {
							if (bio.getText().toString().equals("")) {
								SketchwareUtil.showMessage(getApplicationContext(), "enter bio");
							}
							else {
								if (address.getText().toString().equals("")) {
									...
									if (experience.getText().toString().equals("")) {
										SketchwareUtil.showMessage(getApplicationContext(), "enter experience");
									}
									else {
										map = new HashMap<>();
										map.put("lawyer name", name.getText().toString());
										map.put("lawyer contact", contact.getText().toString());
										map.put("amount", amount.getText().toString());
										map.put("lawyer bio", bio.getText().toString());
										map.put("lawyer address", address.getText().toString());
										map.put("lawyer experience", experience.getText().toString());
		...
		_lawyer_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childValue.containsKey("lawyer name")) {
					name.setText(_childValue.get("lawyer name").toString());
				}
				if (_childValue.containsKey("lawyer contact")) {
					contact.setText(_childValue.get("lawyer contact").toString());
				}
				if (_childValue.containsKey("amount")) {
					amount.setText(_childValue.get("amount").toString());
				}
				if (_childValue.containsKey("lawyer address")) {
					address.setText(_childValue.get("lawyer address").toString());
				}
				if (_childValue.containsKey("lawyer experience")) {
					address.setText(_childValue.get("lawyer experience").toString());
				}
				if (_childValue.containsKey("lawyer bio")) {
