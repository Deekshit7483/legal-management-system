...
public class LAllAppActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.l_all_app);
	...
	public void onBackPressed() {
		i.setClass(getApplicationContext(), LawyerHomeActivity.class);
		startActivity(i);
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.lawyer_, null);
			}
			
			final LinearLayout linear1 = _view.findViewById(R.id.linear1);
			final TextView l_name = _view.findViewById(R.id.l_name);
			final TextView l_contact = _view.findViewById(R.id.l_contact);
			final TextView descriptions = _view.findViewById(R.id.descriptions);
			...
			final Button button5 = _view.findViewById(R.id.button5);
			
			linear1.setVisibility(View.GONE);
			linear3.setVisibility(View.GONE);
			if (_data.get((int)_position).get("lawyer uid").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()) && (_data.get((int)_position).get("status").toString().equals("accept") || _data.get((int)_position).get("status").toString().equals("solved"))) {
				l_name.setText("Client Name:- ".concat(_data.get((int)_position).get("name").toString()));
				l_contact.setText("Client contact:- ".concat(_data.get((int)_position).get("contact").toString()));
				descriptions.setText("Client case:- ".concat(_data.get((int)_position).get("case description").toString()));
				...
				if (_data.get((int)_position).containsKey("time")) {
					time.setText("Time:- ".concat(_data.get((int)_position).get("time").toString()));
					time.setVisibility(View.VISIBLE);
				}
				else {
					time.setVisibility(View.GONE);
				}
				if (_data.get((int)_position).get("status").toString().equals("accept")) {
					textview6.setText("Case Accepted");
					textview6.setTextColor(0xFF4CAF50);
				}
				else {
					if (_data.get((int)_position).get("status").toString().equals("solved")) {
						textview6.setText("Case solved");
						textview6.setTextColor(0xFF4CAF50);
			...
			button5.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					appointment.child(_data.get((int)_position).get("key").toString()).updateChildren(map);
					map.clear();
			...
			button4.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					i.setClass(getApplicationContext(), SelectDateActivity.class);
			...
			_Round(20, 20, 20, 20, "#33b5e5", button5);
